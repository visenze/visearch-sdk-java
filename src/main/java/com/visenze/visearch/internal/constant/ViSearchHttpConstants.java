package com.visenze.visearch.internal.constant;
...
public abstract class ViSearchHttpConstants {
    ...
    public static final String IMAGE_STREAM = "image-stream";
    public static final String X_REQUESTED_WITH = "X-Requested-With";
    public static final String IMAGE = "image";
    public static final String RECOMMENDATION_ALGORITHM = "recommendation_algorithm";
    ...
    public static final String VA_SID = "va_sid";
