...
```java
// client.uploadSearch(params) is equivalent to using STANDARD resize settings, 512x512 and jpeg 85 quality
...
```java
// for images with fine details, use HIGH resize settings 1024x1024 and jpeg 90 quality
